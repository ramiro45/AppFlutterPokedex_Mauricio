...
import 'package:mauricio_flutter_pokedex/controller/getDataController.dart';
import 'package:flutter/services.dart';
import 'package:flutter/src/widgets/framework.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:flutter/src/widgets/container.dart';
import 'package:mauricio_flutter_pokedex/pages/DetailsScreen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _ImagenPokemon(index){
    final Image noImagen = Image.asset('images/icon.png');
    final imageUrl= getDataController.getDataModel.value.results[index].pokImg;
    return Positioned(
      bottom: 5,
      right: 5,
      child: Hero(
